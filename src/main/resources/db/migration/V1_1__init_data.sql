...
# 主页滚动图片
INSERT INTO slide_container (goods_id, pic_url, status, orders, type)
VALUES ('30164', 'https://cdn.it120.cc/apifactory/2018/05/09/2e8638183135b207c97490ed95fb44ba.jpg', TRUE, 1, 'HOME');

INSERT INTO slide_container (goods_id, pic_url, status, orders, type)
VALUES ('30164', 'https://cdn.it120.cc/apifactory/2018/05/09/d1cbc05833c4fa09b1fae15593df1b63.jpg', TRUE, 1, 'HOME');

INSERT INTO slide_container (goods_id, pic_url, status, orders, type)
VALUES ('30164', 'https://cdn.it120.cc/apifactory/2018/05/09/dc11f00add7f97ee549b41b97134fe65.jpg', TRUE, 1, 'HOME');

INSERT INTO slide_container (goods_id, pic_url, status, orders, type)
VALUES ('30164', 'https://cdn.it120.cc/apifactory/2018/05/09/62c5fb354ced6e13c06d554cde479679.jpg', TRUE, 1, 'HOME');



INSERT INTO slide_container (goods_id, pic_url, status, orders, type)
VALUES ('30164', 'https://cdn.it120.cc/apifactory/2018/07/04/c98865950e4684c9f793574db58c814d.jpg', TRUE, 1, 'MENU');

INSERT INTO slide_container (goods_id, pic_url, status, orders, type)
VALUES ('30164', 'https://cdn.it120.cc/apifactory/2018/07/04/aa0f5223d156185bff69b47a0ba4189e.jpg', TRUE, 1, 'MENU');
...
INSERT INTO category (category_id, level, name, pid, is_use, icon, indexs)
