...
import com.feng.util.repository.Criterion.Operator;
...
public class Restrictions {
	...
	public static SimpleExpression asc(String fieldName) {
		return new SimpleExpression(fieldName, null, Operator.ASC);
	}
	
	public static SimpleExpression desc(String fieldName) {

		return new SimpleExpression(fieldName, null, Operator.DESC);
	}
}
