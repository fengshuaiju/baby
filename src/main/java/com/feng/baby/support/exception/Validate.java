 ...
 * <ul>
 *   <li>An invalid {@code null} argument causes a {@link NullPointerValidationException}.</li>
 *   <li>A non-{@code null} argument causes an {@link IllegalArgumentValidationException}.</li>
 *   <li>An invalid index into an array/collection/map/string causes an {@link IndexOutOfBoundsValidationException}.</li>
 * </ul>
 *
...
public class Validate {
     ...
     * @throws IllegalArgumentValidationException if expression is {@code false}
     * @see #isTrue(boolean)
    ...
    public static void isTrue(boolean expression, String message, long value) {
        if (expression == false) {
            throw new IllegalArgumentValidationException(String.format(message, Long.valueOf(value)));
        }
    }
    ...
    public static void isTrue(boolean expression, String message, double value) {
        if (expression == false) {
            throw new IllegalArgumentValidationException(String.format(message, Double.valueOf(value)));
        }
    }
    ...
    public static void isTrue(boolean expression, String message, Object... values) {
        if (expression == false) {
            throw new IllegalArgumentValidationException(String.format(message, values));
        }
    }
    ...
    public static void isTrue(boolean expression) {
        if (expression == false) {
            throw new IllegalArgumentValidationException(DEFAULT_IS_TRUE_EX_MESSAGE);
        }
    }
     ...
     * @throws NullPointerValidationException if the object is {@code null}
    ...
    public static <T> T notNull(T object, String message, Object... values) {
        if (object == null) {
            throw new NullPointerValidationException(String.format(message, values));
        }
        return object;
    }
     ...
     * @throws NullPointerValidationException if the array is {@code null}
     * @throws IllegalArgumentValidationException if the array is empty
     * @see #notEmpty(Object[])
     */
     ...
     * @throws NullPointerValidationException if the collection is {@code null}
     * @throws IllegalArgumentValidationException if the collection is empty
     * @see #notEmpty(Object[])
     */
     ...
     * @throws NullPointerValidationException if the map is {@code null}
     * @throws IllegalArgumentValidationException if the map is empty
     * @see #notEmpty(Object[])
     */
     ...
     * @throws NullPointerValidationException if the character sequence is {@code null}
     * @throws IllegalArgumentValidationException if the character sequence is empty
     ...
     * @return the validated character sequence (never {@code null} method for chaining)
     * @throws NullPointerValidationException if the character sequence is {@code null}
     * @throws IllegalArgumentValidationException if the character sequence is blank
     ...
     * @return the validated array (never {@code null} method for chaining)
     * @throws NullPointerValidationException if the array is {@code null}
     * @throws IllegalArgumentValidationException if an element is {@code null}
    ...
    public static <T> T[] noNullElements(T[] array, String message, Object... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            if (array[i] == null) {
                ...
                throw new IllegalArgumentValidationException(String.format(message, values2));
            }
        }
        return array;
    }
     ...
     * @throws NullPointerValidationException if the array is {@code null}
     * @throws IndexOutOfBoundsValidationException if the index is invalid
    ...
    public static <T> T[] validIndex(T[] array, int index, String message, Object... values) {
        ...
        if (index < 0 || index >= array.length) {
            throw new IndexOutOfBoundsValidationException(String.format(message, values));
        }
        return array;
    }
     ...
     *
     * @param expression  the boolean expression to check
     * @throws IllegalStateValidationException if expression is {@code false}
    ...
    public static void validState(boolean expression) {
        if (expression == false) {
            throw new IllegalStateValidationException(DEFAULT_VALID_STATE_EX_MESSAGE);
        }
    }
    ...
    public static void validState(boolean expression, String message, Object... values) {
        if (expression == false) {
            throw new IllegalStateValidationException(String.format(message, values));
        }
    }
     ...
     * @throws IllegalArgumentValidationException if the character sequence does not match the pattern
    ...
    public static void matchesPattern(CharSequence input, String pattern) {
        if (Pattern.matches(pattern, input) == false) {
            throw new IllegalArgumentValidationException(String.format(DEFAULT_MATCHES_PATTERN_EX, input, pattern));
        }
    }
     ...
     * @throws IllegalArgumentValidationException if the value falls out of the boundaries
    ...
    public static <T> void inclusiveBetween(T start, T end, Comparable<T> value) {
        if (value.compareTo(start) < 0 || value.compareTo(end) > 0) {
            throw new IllegalArgumentValidationException(String.format(DEFAULT_INCLUSIVE_BETWEEN_EX_MESSAGE, value, start, end));
        }
    }
    ...
    public static <T> void exclusiveBetween(T start, T end, Comparable<T> value) {
        if (value.compareTo(start) <= 0 || value.compareTo(end) >= 0) {
            throw new IllegalArgumentValidationException(String.format(DEFAULT_EXCLUSIVE_BETWEEN_EX_MESSAGE, value, start, end));
        }
    }
     ...
     * @throws IllegalArgumentValidationException if argument is not of specified class
    ...
    public static void isInstanceOf(Class<?> type, Object obj) {
        if (type.isInstance(obj) == false) {
            throw new IllegalArgumentValidationException(String.format(DEFAULT_IS_INSTANCE_OF_EX_MESSAGE, type.getName(),
     ...
     * @throws IllegalArgumentValidationException if type argument is not assignable to the specified superType
    ...
    public static void isAssignableFrom(Class<?> superType, Class<?> type) {
        if (superType.isAssignableFrom(type) == false) {
            throw new IllegalArgumentValidationException(String.format(DEFAULT_IS_ASSIGNABLE_EX_MESSAGE, type == null ? "null" : type.getName(),
                    superType.getName()));
        }
    }
     ...
     * @param message  the {@link String#format(String, Object...)} exception message if invalid, not null
     * @param values  the optional values for the formatted exception message, null array not recommended
     * @throws IllegalArgumentValidationException if argument can not be converted to the specified class
